...
\item
  ...
  En mission au CENTAI (\emph{Centre de Traitement et d’Analyse de l’Information}), laboratoire d'études amonts de \emph{Thales Communications \& Security} spécialisé en \emph{Big Data}, \emph{Big Analytics} et \emph{Visual Analytics} :
...
\begin{itemize}
  ...
  \item \emph{Langages de programmation :} C/C++, Java, Python, JavaScript (\emph{full-stack}), HTML, CSS, Scripts Bat et Bash, \ldots
  \item \emph{Outils de gestion de version :} Git, Subversion, \ldots
  \item \emph{Outils de développement C/C++ :} CMake, Valgrind, GDB, \ldots
  \item \emph{Outils de développement JavaScript :} Node.js, Npm, Yarn, Webpack, Babel, Emscripten, Gulp 
  \item \emph{Bibliothèques/API C/C++ :} Qt, OpenGL, Tulip, Python, \ldots
  \item \emph{Bibliothèques/API JavaScript :} Angular, Lodash, Bootstrap, D3, WebGL, Leaflet, Asm.js, WebAssembly \ldots
  \item \emph{Technologies Big Data :} Hadoop, HDFS, Spark, Elasticsearch, Kafka, \ldots
  \item \emph{Outils de virtualisation :} VirtualBox, docker, \ldots
  \item \emph{Outils de documentation :} Sphinx, Markdown, doxygen, \LaTeX, \ldots
